                ...
                <tbody>
                  ...
                  foreach ($data_almacen as $dato_almacen) {
                    ...
                    <tr>
                      ...
                      <td>
                        <button onclick="editar(<?=$categorias_dato['id_almacen'];?>)" class="btn btn-warning btn-sm">
                          <i class="fas fa-edit"></i>
                        </button>
                        <button onclick="eliminar(<?=$categorias_dato['id_almacen'];?>)" class="btn btn-danger btn-sm">
