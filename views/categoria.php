        ...
        <div class="col-md-6">
          <div class="card card-outline card-primary">
            <div class="card-header ">
              <h3 class="card-title mb-0">Categorias registradas</h3>
            ...
            <div class="card-body">
              <table id="examplel" class="table table-bordered table-atriped">
                ...
                <tbody>
                  <?php
                  $contador = 0;
                  foreach ($data_categorias as $categorias_dato) {
                    ...
                    <tr>
                      ...
                      <td>
                        <button onclick="editar(<?=$categorias_dato['id_categoria'];?>)" class="btn btn-warning btn-sm">
                          <i class="fas fa-edit"></i>
                        </button>
                        <button onclick="eliminar(<?=$categorias_dato['id_categoria'];?>)" class="btn btn-danger btn-sm">
      ...
      <form action="" method="post">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" name="nombre_categoria" maxlength="15" class="form-control" placeholder="Escriba aquí el nombre de la categoria">
